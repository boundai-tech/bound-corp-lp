        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="flex-1 relative">
              {/* 引用符アイコン */}
              <svg className="absolute -top-4 -left-2 w-10 h-10 md:w-12 md:h-12 text-[#0891B2]/20 z-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z"/>
              </svg>
              
              <p className="text-[16px] md:text-[18px] lg:text-[22px] leading-[1.7] md:leading-[1.8] text-foreground/90 font-medium relative z-10">
                AIで自社のビジネスや職種を反映したジョブチャレンジを瞬時に作成できたので、<span className="text-[#0891B2] bg-[#ECFEFF] px-1 mx-1 rounded">従来2ヶ月かかっていた設計が30分で完了</span>しました。学生がAIと共に取り組むことで、企業理解を深めた状態でのエンゲージメント強化が期待できます。
              </p>
            </div>
