...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 lg:py-32 px-4 md:px-6 bg-surface">
      <div className="max-w-[600px] mx-auto">
        <ScrollReveal>
          <h2 className="text-[22px] md:text-[26px] font-semibold text-foreground/90 text-center mb-4 leading-tight tracking-tight">
            お問い合わせ
          </h2>
          <p className="text-center text-foreground/60 text-[15px] mb-8 md:mb-12">
