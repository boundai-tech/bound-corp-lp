...
const problems = [
  {
    title: "職種別コンテンツ設計の負担",
    description: "職種ごとにジョブ体験を設計する工数が大きく、特に専門職では業務理解がないと設計自体が難しい。",
  },
  {
    title: "ニッチ職種の母集団形成",
    description: "専門職ほど学生の母集団は小さく、企業認知が弱い場合は適切な学生を集めること自体が難しい。",
  },
  {
    title: "職種別スキル評価の難しさ",
    description: "ポテンシャルではなく職種スキルを評価する必要があり、評価軸の設計や面接官間の評価ブレが課題になる。",
  },
];
