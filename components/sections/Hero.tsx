      ...
      >
        ...
        >
          <Link 
            ...
            className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3.5 sm:py-3 rounded-full bg-[#0891B2] text-white text-[15px] sm:text-[15px] md:text-[16px] font-semibold hover:bg-[#0891B2]/90 transition-all shadow-lg hover:shadow-xl hover:scale-105 gap-2"
          >
            無料で試す
          ...
          <Link 
            href="#contact" 
            className="hidden sm:inline-flex items-center justify-center px-5 sm:px-6 py-2.5 sm:py-3 rounded-full border border-foreground/20 sm:border-2 text-foreground text-[13px] sm:text-[15px] md:text-[16px] font-medium hover:border-foreground/40 hover:bg-foreground/5 transition-all"
          >
            資料請求・問合せ
          </Link>
          <Link
            href="#contact"
            className="sm:hidden text-[13px] text-foreground/40 hover:text-foreground/70 transition-colors"
          >
            資料請求・問合せ
          </Link>
        </motion.div>
